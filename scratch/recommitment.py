...
class StorageProver:
    def __init__(self, g, h):
        ...
        self.data_history = {}  # Store data history
        self.commitments_history = {}  # Store commitment history
        self.random_vals_history = {}  # Store random values history
    ...
    def store_data(self, data_blocks):
        ...
        # Store in history
        self.data_history[self.current_period] = data_hashed
        self.commitments_history[self.current_period] = commitments
        self.random_vals_history[self.current_period] = random_vals

        return self.merkle_tree.get_merkle_root()

    def recommit_data(self):
        """Recommit the data for the current period"""
        current_data = self.data_history[self.current_period]
        self.store_data(list(current_data.values()))
