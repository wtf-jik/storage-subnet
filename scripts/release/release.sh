...
#
# In this script you are going to find the process of releasing FileTAO.
#
# This script needs:
...
#   - Tag in Github repo: https://github.com/ifrit98/storage-subnet/tags
#   - Release in Github: https://github.com/ifrit98/storage-subnet/releases
#   - New entry in CHANGELOG.md file
#   - Python wheel in pypi: https://pypi.org/project/filetao/
#
...
function help(){
    ...
    echo \ \  $0
    echo
    echo This script releases a FileTAO version.
    echo
...
#  - VERSION file exists
#  - __version__ exists inside file 'storage/__init__.py'
